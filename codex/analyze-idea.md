...
|-----------|--------|---------------|
| Problem Severity | x2.0 | 0=no real pain, 10=critical daily suffering |
| Market Size | x2.0 | 0=niche of niche, 10=massive global market |
| Competition Intensity | x1.5 | 10=blue ocean, 0=saturated red ocean |
| Technical Feasibility | x1.5 | 0=impossible, 10=build in a weekend |
| Monetization Potential | x1.5 | 0=no clear model, 10=obvious high-margin revenue |
| Personal Excitement | x0.5 | 0=meh, 10=you'd work on this for free |
| Time to MVP | x0.5 | 10=<1 month, 7=1-3 months, 5=3-6 months, 2=6-12 months, 0=>1 year |
| Defensibility | x0.5 | 0=easily copied, 10=strong data/network/IP moat |
...
Generate the full report below, replacing ALL placeholders with real, specific content. Then save it to disk.
...
|------|------|-----------|--------|-----|
| {Dataset/API name} | {Free / Open / Freemium / Paid} | {how it's used in the product} | {API key / direct download} | {url} |
...
- **Industry Regulations:** {sector-specific — e.g., HIPAA for health, PCI-DSS for payments}
...
**North Star Metric:** {The single number that best captures product value}
...
|-----------|-----------------|--------|-----------------|
| Problem Severity | {X}/10 | x2.0 | {X*2} |
| Market Size | {X}/10 | x2.0 | {X*2} |
| Competition Intensity | {X}/10 | x1.5 | {X*1.5} |
| Technical Feasibility | {X}/10 | x1.5 | {X*1.5} |
| Monetization Potential | {X}/10 | x1.5 | {X*1.5} |
| Personal Excitement | {X}/10 | x0.5 | {X*0.5} |
| Time to MVP | {X}/10 | x0.5 | {X*0.5} |
| Defensibility | {X}/10 | x0.5 | {X*0.5} |
| **TOTAL** | | | **{TOTAL}/100** |
...
1. **Save the file** to `VAULT_PATH_PLACEHOLDER/Ideas/Research/{YYYY-MM-DD}-{slug}.md` by writing it to disk
